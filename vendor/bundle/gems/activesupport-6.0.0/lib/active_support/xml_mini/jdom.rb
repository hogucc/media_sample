...
module ActiveSupport
  module XmlMini_JDOM #:nodoc:
    ...
    NODE_TYPE_NAMES = %w[ATTRIBUTE_NODE CDATA_SECTION_NODE COMMENT_NODE DOCUMENT_FRAGMENT_NODE
                         ...
                         PROCESSING_INSTRUCTION_NODE TEXT_NODE].freeze
