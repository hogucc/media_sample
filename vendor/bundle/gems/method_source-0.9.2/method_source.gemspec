...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0')
      s.add_development_dependency('rake'.freeze, ['~> 0.9'])
      s.add_development_dependency('rspec'.freeze, ['~> 3.6'])
    else
      s.add_dependency('rake'.freeze, ['~> 0.9'])
      s.add_dependency('rspec'.freeze, ['~> 3.6'])
    end
  else
    s.add_dependency('rspec'.freeze, ['~> 3.6'])
    s.add_dependency('rspec'.freeze, ['~> 3.6'])
