...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Materializecss rubygem for rails/sprockets base'
  spec.description   = 'A modern responsive front-end framework based on Material Design. https://materializecss.com/'
