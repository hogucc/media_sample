    ...
    module FormTagHelper
      ...
      def select_tag(name, option_tags = nil, options = {})
        ...
        if options.include?(:include_blank)
          ...
          option_tags = content_tag('option', include_blank, options_for_blank_options_tag).safe_concat(option_tags) if include_blank
        end
      ...
      def label_tag(name = nil, content_or_options = nil, options = nil, &block)
        ...
        options['for'] = sanitize_to_id(name) unless name.blank? || options.key?('for')
      ...
      def convert_direct_upload_option_to_url(options)
        options['data-direct-upload-url'] = rails_direct_uploads_url if options.delete(:direct_upload) && respond_to?(:rails_direct_uploads_url)
        options
      end
    end
  end
