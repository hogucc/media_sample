...
module Mail
  class Ruby19
    ...
    def self.transcode_charset(str, from_encoding, to_encoding = Encoding::UTF_8)
    ...
    def self.q_value_encode(str, encoding = nil)
      encoding = str.encoding.to_s
    ...
    def self.pick_encoding(charset)
