      ...
      class HelperMethodBuilder # :nodoc:
        ...
        def self.polymorphic_method(recipient, record_or_hash_or_array, action, type, options)
          ...
          when Array
            ...
            raise ArgumentError, "Nil location provided. Can't build URI." if record_or_hash_or_array.empty?

            recipient = record_or_hash_or_array.shift if record_or_hash_or_array.first.is_a?(ActionDispatch::Routing::RoutesProxy)
