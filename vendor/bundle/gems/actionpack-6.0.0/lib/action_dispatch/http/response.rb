...
module ActionDispatch # :nodoc:
  ...
  class Response
    class Header < DelegateClass(Hash) # :nodoc:
      ...
      def []=(k, v)
        raise ActionDispatch::IllegalStateError, 'header already sent' if @response.sending? || @response.sent?
    ...
    CONTENT_TYPE_PARSER = /\A(?<type>[^;\s]+)?(?:.*;\s*charset=(?<quote>"?)(?<charset>[^;\s]+)\k<quote>)?/.freeze # :nodoc:
