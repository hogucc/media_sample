  ...
  module Assertions
    ...
    module RoutingAssertions
      ...
      def assert_generates(expected_path, options, defaults = {}, extras = {}, message = nil)
        ...
        found_extras = options.select { |k, _| query_string_keys.include? k }
      ...
      def assert_routing(path, options, defaults = {}, extras = {}, message = nil)
        ...
        options[:controller] = "/#{controller}" if controller&.include?('/') && default_controller && default_controller.include?('/')
