    ...
    class AbstractAdapter
      class SchemaCreation # :nodoc:
        ...
        def visit_TableDefinition(o)
          ...
          statements.concat(o.indexes.map { |column_name, options| index_in_create(o.name, column_name, options) }) if supports_indexes_in_create?

          statements.concat(o.foreign_keys.map { |to_table, options| foreign_key_in_create(o.name, to_table, options) }) if supports_foreign_keys?
