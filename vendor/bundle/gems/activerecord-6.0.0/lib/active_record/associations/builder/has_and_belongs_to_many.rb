...
module ActiveRecord::Associations::Builder # :nodoc:
  class HasAndBelongsToMany # :nodoc:
    ...
    def middle_options(join_model)
      ...
      middle_options[:foreign_key] = options[:foreign_key] if options.key? :foreign_key
      middle_options
    end
    ...
    def belongs_to_options(options)
      ...
      rhs_options[:foreign_key] = options[:association_foreign_key] if options.key? :association_foreign_key
