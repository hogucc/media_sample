  ...
  module Visitors
    ...
    class ToSql < Arel::Visitors::Visitor
      ...
      def visit_Arel_Nodes_In(o, collector)
        return collect_in_clause(o.left, o.right, collector) unless Array === o.right

        o.right.delete_if { |value| unboundable?(value) } unless o.right.empty?
      ...
      def visit_Arel_Nodes_NotIn(o, collector)
        return collect_not_in_clause(o.left, o.right, collector) unless Array === o.right
